...
import org.rivchain.cuplink.rivmesh.MeshStateReceiver.Companion.MESH_STATE_INTENT
import mobile.Mesh
import org.json.JSONArray
import org.rivchain.cuplink.MainApplication
import org.rivchain.cuplink.PREF_KEY_ENABLED
import org.rivchain.cuplink.createServiceNotification
...
open class PacketTunnelProvider: VpnService() {
    companion object {
        const val STATE_INTENT = "org.rivchain.cuplink.rivmesh.PacketTunnelProvider.STATE_MESSAGE"
        const val ACTION_START = "org.rivchain.cuplink.rivmesh.PacketTunnelProvider.START"
        const val ACTION_STOP = "org.rivchain.cuplink.rivmesh.PacketTunnelProvider.STOP"
        const val ACTION_TOGGLE = "org.rivchain.cuplink.rivmesh.PacketTunnelProvider.TOGGLE"
        const val ACTION_CONNECT = "org.rivchain.cuplink.rivmesh.PacketTunnelProvider.CONNECT"
    }
    ...
    private fun start() {
        ...
        mesh.startJSON(config.getJSONByteArray())
        ...
        var intent = Intent(MESH_STATE_INTENT)
    ...
    private fun stop() {
        ...
        intent = Intent(MESH_STATE_INTENT)
    ...
    private fun updater() {
        ...
        updates@ while (started.get()) {
            ...
            if (lastStateUpdate + 10000 < curTime) {
                val intent = Intent(MESH_STATE_INTENT)
